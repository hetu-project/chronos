...
use crate::{unit_tests::uniform_keypair_strategy, ecvrf::*};
...
const TESTVECTORS : [VRFTestVector; 3] = [
    VRFTestVector {
        ...
        alpha : b"",
        x : "7c2cac12e69be96ae9065065462385e8fcff2768d980c0a3a520f006904de90f",
    ...
    VRFTestVector {
        ...
        alpha : b"\x72",
        x : "c799d106d5927970e5989f5671131fa27e6c6b3b7f821c5e259a24b02e502e01",
    ...
    VRFTestVector {
        ...
        alpha : b"\xaf\x82",
        x : "ef76bea4dae9a6cb6013cf2cbce0e2a8b94d7f4ec5c2f51b1325a181991ea90c",
        // try_and_increment succeeded on ctr = 0
...
#[test]
fn gen_keypair_prove_and_verify() {
    let message = b"Test message, hello, hetu!";
    ...
    let random_num: Output = (&proof).into();
    println!("random output: {:?}", ::hex::encode(random_num.to_bytes()));
}
