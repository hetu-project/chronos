...
impl DerivedDiscoveryBehaviour {
...
impl<'a> DiscoveryConfig<'a> {
    ...
    pub fn finish(self) -> anyhow::Result<DiscoveryBehaviour> {
        ...
        let auto_nat_opt = if enable_auto_nat {
            Some(autonat::Behaviour::new(local_peer_id, Default::default()))
        } else {
            None
        };
...
impl DiscoveryBehaviour {
    ...
    pub fn seed_peers(&self) -> &Vec<(PeerId, Multiaddr)> {
        &self.custom_seed_peers
    }

    pub fn node_connected_count(&self) -> u64 {
                        ...
                        DerivedDiscoveryBehaviourEvent::Mdns(ev) => match ev {
                            MdnsEvent::Discovered(list) => {
                                ...
                                info!(
                                    ...
                                    self.n_node_connected, self.target_peer_count
                                );
